...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="{{ asset('project/public/installer/img/favicon/favicon-16x16.png') }}" sizes="16x16"/>
        <link rel="icon" type="image/png" href="{{ asset('project/public/installer/img/favicon/favicon-32x32.png') }}" sizes="32x32"/>
        <link rel="icon" type="image/png" href="{{ asset('project/public/installer/img/favicon/favicon-96x96.png') }}" sizes="96x96"/>
        <link href="{{ asset('project/public/installer/css/style.css') }}" rel="stylesheet"/>
        @yield('style')
        <script>
