...
<!-- Begin Page Content -->
 ...
 <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">@lang('Add New Advertisement')</h1>
    

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">@lang('Add New Ads')</h6>

        </div>
        <div class="card-body">


            <form method="POST" action="{{ route('admin.advertisement.store') }}" enctype="multipart/form-data" class="item-form">
               @csrf

               
               <img class="h-100 img-fluid mx-auto prv" src="{{ asset('assets/images/no-image.png') }}" alt="" id="show">
             ...
             <div class="row ">
                 ...
                 <div class="col-md-6 mt-4 ">
                    ...
                    <select class="form-control" data-toggle="select" name="position" id="position">
                        <option value="side_banner">@lang('Side Banner')</option>
                        <option value="content_banner">@lang('Content Banner')</option>
                    </select>
                </div>
                ...
                <div class="col-md-6 mt-4">
                 ...
                 <div class="col-md-6 mt-4">
                  ...
                  <input type="url" class="form-control" id="source" name="link" value="">
              </div>
            ...
            <div class="col-md-6 mt-4">
                ...
                <input type="number" class="form-control" id="source" name="duration" value="" placeholder="In second">
            </div>
