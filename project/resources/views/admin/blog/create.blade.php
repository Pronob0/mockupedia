...
<!-- Begin Page Content -->
 ...
 <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">@lang('Add New Blog')</h1>
    

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">@lang('Add New Blog')</h6>

        </div>
        <div class="card-body">


            <form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data" class="item-form">
               @csrf
             ...
             <div class="row">
                 ...
                 <div class="col-md-6 mt-4">
                  ...
                  <input type="url" class="form-control" id="source" name="source" value="">
              </div>
                ...
                <div class="col-md-12 mt-4">
                     ...
                     <textarea class="form-control" id="nicedit" name="description" rows="3" ></textarea>
                 </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <input class="form-control" id="meta_tag" name='meta_keyword[]' value=''>
               </div>
